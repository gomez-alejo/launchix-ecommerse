...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <!-- Login Form -->
        <form method="POST" action="{{ route('login.user') }}" class="glass-effect p-8 rounded-2xl shadow-2xl">
            @csrf
            ...
            <div class="text-center mt-6">
                <p class="text-gray-600">
                    ¿No tienes cuenta? 
                    <a href="{{ route('register.user') }}" class="text-primary hover:text-secondary font-semibold transition-colors">
                        Regístrate aquí
                    </a>
                </p>
            </div>
        ...
        <div class="text-center mt-6 text-sm text-gray-500">
            <p>© 2025 Launchix. Todos los derechos reservados.</p>
        </div>
    </div>
</body>
</html>